...
void loop() {
    ...
    if (newData == true) {
        ...
        float x = packet.packet_int;
        float y =packet.packet_int2;
        float distance = sqrt (x*x + y*y);
        analogWrite (13, 255 - (distance/100.0)*255);
...
dataPacket parseData() {      // split the data into its parts
    ...
    tmpPacket.packet_int2 = atoi(strtokIndx);     // convert this part to a float
